...
const Hero = () => {
  ...
  return (
    <div
      className="max-w-screen-xl mt-16 px-8 xl:px-12 mx-auto"
      id="inicio"
    >
      <ScrollAnimationWrapper>
          <motion.div
            className="grid grid-flow-row sm:grid-flow-col grid-rows-2 md:grid-rows-1 sm:grid-cols-2 md:gap-8 py-6 sm:pt-8"
